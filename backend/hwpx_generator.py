...
구조:
  template_box_head_01.hwpx   → 제목 박스 ({{report_title}})
  template_box_summary_01.hwpx → 요약 박스 ({{summary_line_1}}, {{summary_line_2}})
...
HEAD_TPL = os.path.join(os.path.dirname(__file__), "template_box_head_01.hwpx")
SUMM_TPL = os.path.join(os.path.dirname(__file__), "template_box_summary_01.hwpx")
